 ...
 */
class ConeShell : public Mesh
{
public:

    ConeShell(int num_cols, int num_rows,
                             glm::mat4 transformPositions, glm::mat4 transformNormals);
    ConeShell(int numCols, int numRows, glm::mat4 transformPositions);
    ConeShell(int numCols, int numRows);
